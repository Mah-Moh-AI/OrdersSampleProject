    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("735886c0-faf3-49ca-9776-8a20b756f1cb"), "Jane Smith", new DateTime(2024, 5, 8, 18, 23, 12, 696, DateTimeKind.Local).AddTicks(4499), "ORD002", 225.8m },
                    { new Guid("f4816224-70d6-4491-ac52-34f298ace16f"), "John Doe", new DateTime(2024, 5, 8, 18, 23, 12, 696, DateTimeKind.Local).AddTicks(4445), "ORD001", 66.5m }
                });
        }
